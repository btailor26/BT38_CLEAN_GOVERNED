"""Small governed autosave route for FBM packed-parcel values.

The route only persists shipping-desk measurements for an already-existing FBM
MarketplaceOrder. It does not buy postage, dispatch, mutate inventory or call a
